...
class DirtyFileWatcher {
  ...
  constructor(files = [], extensions = 'js') {
    ...
    this.globs = (0, _utils.parseFoldersToGlobs)(files, extensions);
  }
  /**
  ...
  filterChangedFiles(fileTimestamps, globs) {
    ...
    for (const [filename, timestamp] of fileTimestamps.entries()) {
      if (hasFileChanged(filename, timestamp) && (0, _micromatch.isMatch)(filename, globs)) {
...
exports.default = DirtyFileWatcher;